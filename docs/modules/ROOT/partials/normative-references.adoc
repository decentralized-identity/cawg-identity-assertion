...
* https://spec.c2pa.org/specifications/specifications/2.4/specs/C2PA_Specification.html[C2PA technical specification, version 2.4]
...
* https://trustoverip.github.io/tswg-trust-registry-protocol/approved/[Trust Registry Query Protocol (TRQP), version 2.0]
* https://www.w3.org/TR/vc-bitstring-status-list/[Bitstring Status List, version 1.0]
