...
IMPORTANT: A *CAWG identity assertion consumer* SHOULD NOT display any icon or logo, regardless of source, unless the certificate status is deemed to be trusted.
