...
It can be located as described in link:https://spec.c2pa.org/specifications/specifications/2.4/specs/C2PA_Specification.html#x509_certificates[Section 14.5, “X.509 certificates,”] of the C2PA technical specification.
