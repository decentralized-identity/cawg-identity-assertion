...
*Version 1.2 DIF Ratified Specification 15 December 2025* · xref:_version_history[]

IMPORTANT: This specification differs from the link:https://cawg.io/identity/1.1/[1.1 version] primarily in the addition of xref:_trust_model_for_x_509_certificates[xrefstyle=full].
