...
* The *<<_identity_assertion,identity assertion>>* generator SHALL use a certificate that complies with the trust model described in xref:_trust_model_for_x_509_certificates[xrefstyle=full].
