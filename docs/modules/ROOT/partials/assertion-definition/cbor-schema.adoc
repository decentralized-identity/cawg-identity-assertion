...
----
{
  "signer_payload": {
    ...
    "trust_registry": {
      ...
      "entity_id": "user-1234",
      "authority_id": "academicResearchPublicationAuthority",
      "action": "publish",
      "resource": "researchPublication",
      "context": { optional },
      // { jouralist right to publish newsArticle.text },
      // { photograph right to publish photo.journalist },
    },
    "role": ["cawg.creator"],
  },
