...
TO DO: Add instructions for how to validate trust registry information if it exists. Look at TRQP validation query request and response pattern.

https://trustoverip.github.io/tswg-trust-registry-protocol/approved/

TO DO: Encourage caching of responses to avoid overload.

FROM Charlie: suggest we use a resource of "https://cawg.io/identity-validation-credential" that we define, then write an "identity validation" requirements / policy document.
