...
If so, this time stamp shall be generated as described by link:++https://spec.c2pa.org/specifications/specifications/2.4/specs/C2PA_Specification.html#_time_stamps++[Section 11.3.2.5, “Time-stamps,”] of the C2PA technical specification.
