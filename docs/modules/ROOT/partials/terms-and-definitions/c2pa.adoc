...
The following definitions are adapted from the link:++https://spec.c2pa.org/specifications/specifications/2.3/specs/C2PA_Specification.html#_glossary++[glossary] provided in the C2PA technical specification.
...
See link:++https://spec.c2pa.org/specifications/specifications/2.3/specs/C2PA_Specification.html#_claims++[Section 10, “Claims,”] of the C2PA technical specification.
...
See link:++https://spec.c2pa.org/specifications/specifications/2.3/specs/C2PA_Specification.html#_assertions++[Section 6, “Assertions,”] of the C2PA technical specification.
...
See link:++https://spec.c2pa.org/specifications/specifications/2.3/specs/C2PA_Specification.html#_manifests++[Section 11, “Manifests,”] of the C2PA technical specification.
...
See link:++https://spec.c2pa.org/specifications/specifications/2.3/specs/C2PA_Specification.html#_manifest_store++[Section 11.1.4.2, “Manifest Store,”] of the C2PA technical specification.
...
Content bindings are described in link:++https://spec.c2pa.org/specifications/specifications/2.3/specs/C2PA_Specification.html#_binding_to_content++[Section 9, “Binding to content,”] of the C2PA technical specification.

==== Hard binding

One or more cryptographic hashes that uniquely identifies either the entire _<<C2PA asset>>_ or a portion thereof.

Hard bindings are described in link:++https://spec.c2pa.org/specifications/specifications/2.3/specs/C2PA_Specification.html#_hard_bindings++[Section 9.2, “Hard bindings,”] of the C2PA technical specification.
