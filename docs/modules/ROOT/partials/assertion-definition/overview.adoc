...
* `trust_registry_uri` contains a URI identifying the _<<_trust_registry,trust registry>>_ that defines the governance framework, trust rules, or authorized entities relevant to this assertion. *TO DO:* Should this be defined in terms of ToIP TRQP?
